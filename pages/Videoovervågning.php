...
<body>
    ...
    <div class="product-section">
        <div class="product-wrapper">
            ...
            <div class="produkter">
                <h2>Videoovervågning</h2>
                <hr>
                    <div class="kategori-valg" >
                        <div class="produkt-wrap">
                            <a href="categories/kamera.php">
                                <img src="../assets/images/0021994_ajax-kamera_450.png" alt="Camera Y" class="produkt-listevisning-img">
                                <h4 style="display: flex;justify-content:  center; font-weight: 400;">Ajax Kamera</h4>
                            </a>
    
                        </div>
                        <div class="produkt-wrap">
                            <a href="categories/NVRoptager.php">
                                <img src="../assets/images/0021710_ajax-nvr-optager_450.png" alt="Camera Y" class="produkt-listevisning-img">
                                <h4 style="display: flex;justify-content:  center; font-weight: 400;">Ajax NVR optager</h4>
                            </a>
                        </div>
